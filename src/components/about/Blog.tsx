    ...
    <Container>
      <Row className="produce" >
          <Col  xs={{ order: 'first' }} className="font text-center">
                  ...
                  2002年に京都府で生まれ（現大学3年生）小学生〜大学2年生秋までサッカーに打ち込んでいました。高校時には香川県で寮生活をして、全国高校サッカー選手権に出場、その後国士舘大学に入学を決め、サッカー部に所属。2年生の秋に1年休学をしてドイツにサッカー留学。怪我などもあり、サッカー選手になることをあきらめ、渡航中にエンジニアを目指すことにシフトチェンジしました。現在は株式会社マネーフォワードとHOUSEI株式会社でTypeScript,React,Go,Railsなどを中心とした業務を担当しています。
                  </p>          
          </Col>
      </Row>
